...
export const createService = (body: CreateServiceInput) =>
  apiClient.post<Service>(BASE, body).then((r) => r.data);
export const updateService = (id: string, body: Partial<CreateServiceInput>) =>
  apiClient.put<Service>(`${BASE}/${id}`, body).then((r) => r.data);
