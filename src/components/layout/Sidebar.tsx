...
import {
  LayoutDashboard, Shield, Users, Briefcase, CalendarDays,
  Eye, UserCheck, Truck, Settings, HelpCircle, Heart, LogOut,
  Compass, GraduationCap, Baby, MessageCircleQuestion,
  Tag, Package, Ticket, ShoppingCart,
} from 'lucide-react'
...
export default function Sidebar({ user }: Props) {
  ...
  return (
    <aside className="fixed top-0 left-0 h-full w-52 flex flex-col" style={{ backgroundColor: '#17263A' }}>
      {/* Logo */}
      <div className="flex items-center gap-3 px-4 py-4 border-b border-white/10">
        <div className="w-9 h-9 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#2A5298' }}>
          <Heart size={18} className="text-white" fill="white" />
        </div>
        <div>
          <p className="text-white text-sm font-semibold leading-tight">Acompáñame</p>
      ...
      <nav className="flex-1 overflow-y-auto py-4 px-2">
        <p className="text-white/30 text-xs font-medium px-2 mb-2 tracking-wider">MÓDULOS</p>
        ...
        <p className="text-white/30 text-xs font-medium px-2 mt-4 mb-2 tracking-wider">COMERCIO</p>
        ...
        <p className="text-white/30 text-xs font-medium px-2 mt-4 mb-2 tracking-wider">CONFIGURACIÓN</p>
