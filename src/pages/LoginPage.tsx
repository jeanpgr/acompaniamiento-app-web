    ...
    <div className="min-h-screen flex" style={{ backgroundColor: '#EEF1F8' }}>
      ...
      >
        <div>
          <div className="flex items-center gap-3 mb-12">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ backgroundColor: '#2A5298' }}>
              <Heart size={20} className="text-white" fill="white" />
            </div>
            <div>
              <p className="text-white font-semibold text-lg leading-tight">Acompáñame</p>
              <p className="text-white/40 text-xs">Panel Administrativo</p>
            </div>
          </div>

          <h2 className="text-white text-3xl font-bold leading-tight mb-4">
            Gestiona tu<br />plataforma
          </h2>
          <p className="text-white/50 text-sm leading-relaxed">
            Administra usuarios, servicios, vehículos y agendas desde un solo lugar.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 w-full max-w-sm p-8">
          ...
          <p className="text-sm text-slate-500 mb-7">Ingresa tus credenciales para acceder al panel</p>
