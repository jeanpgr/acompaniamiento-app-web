...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'settings',
        element: <PlaceholderPage icon={Settings} title="Ajustes" subtitle="Configuración general de la plataforma" />,
      },
      {
        path: 'help',
        element: <PlaceholderPage icon={HelpCircle} title="Ayuda" subtitle="Centro de ayuda y preguntas frecuentes" />,
      },
    ],
  },
